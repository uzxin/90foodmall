 ...
 * @author: YX
 * @date: 2020/3/3 11:25
 * @description: redis缓存过期
 */
public class MyRedisCacheWriter implements RedisCacheWriter {
    private final RedisConnectionFactory connectionFactory;
    private final Duration sleepTime;
    private static final String KEY_NULL_ERROR_MSG = "Key must not be null!";
    private static final String NAME_NULL_ERROR_MSG = "Name must not be null!";
    ...
    public void put(String name, byte[] key, byte[] value, @Nullable Duration ttl) {
        ...
        Assert.notNull(name, NAME_NULL_ERROR_MSG);
        Assert.notNull(key, KEY_NULL_ERROR_MSG);
        ...
        execute(name, connection -> {
            ...
            if (index > 0) {
                ...
                long expireTime = Long.parseLong(expireString.replaceFirst("\\..*", "")) * 1000;
